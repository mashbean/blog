...
const normalizeTitle = (value: string): string => value.toLowerCase().replace(/[^\p{L}\p{N}]+/gu, "");
...
export async function buildBlogPageData(options?: { includeDrafts?: boolean; includeFuture?: boolean }) {
