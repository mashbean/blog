# 翻譯：賦稅作為終局之戰 - 豆泥 - Matters

Source: https://matters.town/a/9h9b83gw1tz2
Date: 2024-01-07T12:54:18.969Z
...
就像任何依賴於資訊的事物，都被網路劇烈改變一樣，我相信「金錢的網路」將使價值轉移在社會中發生大型的構造改革。 雖然大部分的數位資產市場都專注於銀行業（DeFi）和藝術品（NFTs），但我仍然專注於長尾應用案例，如網路工作和數位公共財。
...
我認為「透過預算分配來資助公共財」的嘗試在web3世界已經完成，如Gitcoin和Hypercerts表現不錯。
...
政府部門如何真正試驗一些來自公共研究領域的尖端技術（例如，RadicalxChange、Plurality community）？

政府部門如何真正試驗一些來自公共研究領域的尖端技術（例如，RadicalxChange、Plurality community）？

非營利組織如何在其生態系中找到稅收途徑，並促進生態系發展
...
資助公共財：對於社區中廣泛且涵融的人，有價值的專案，但往往沒有商業模式（例如第一層和第二層區塊鏈協議研究、客戶端開發、文檔等），如何獲得資金支持？

區塊鏈協議維護和升級：協議的升級以及對長期不穩定的協議（如安全資產列表、價格預測來源、多方計算金鑰持有者）的定期維護和調整操作，是如何達成共識的？
...
他们利用去中心的傳播方法，来决定应该资助什么

他们使慈善或政府支出，更有效率，更接地氣

他們藉由中央補助款，給予小額贊助者動機來捐款
...
公共財專案列在一個定期的撥款分配輪次中，稱為Gitcoin Grant Round

公共財專案列在一個定期的撥款分配輪次中，稱為Gitcoin Grant Round

以太坊生態系的任何公民都可以捐贈給他們喜愛的專案

以太坊生態系的任何公民都可以捐贈給他們喜愛的專案

根據捐贈的地點和金額，資金從配對基金池（資助預算）分配給每個專案
...
Gitcoin的Q3配對：超過10萬美元用於開源專案

Gitcoin的Q3配對：超過10萬美元用於開源專案

Case Study: UNICEF 案例研究：聯合國兒童基金會
...
第1至6輪的資金來自以太坊基金會（有時也有小額捐助者）。

第1至6輪的資金來自以太坊基金會（有時也有小額捐助者）。

第7至10轮的资金来自DeFi协议，如Yearn/Synthetix/Chainlink，投资者如三箭资本，以及其他数十位社区成员

第7至10轮的资金来自DeFi协议，如Yearn/Synthetix/Chainlink，投资者如三箭资本，以及其他数十位社区成员

第11+輪的資金來源包括（除了之前的資金機制外）像是Moonshotbots這樣的NFT。Gitcoin已經嘗試從NFT基金（Moonshot Bots）中獲得資金，從社群中籌集到了180萬美元。
...
貢獻者是設立專案的人，而非營利組織（NPO）的創辦人等也可能屬於這個類別。

貢獻者是設立專案的人，而非營利組織（NPO）的創辦人等也可能屬於這個類別。

我認為潛在的資助者通常是出於投機目的。然而，在公共財專案的情況下，“IPO（退出）”是由回顧性資助者分配資金。這個資助者具體指的是投資DAO，或者可以解釋為“投資非營利組織的風險投資公司”。

我認為潛在的資助者通常是出於投機目的。然而，在公共財專案的情況下，“IPO（退出）”是由回顧性資助者分配資金。這個資助者具體指的是投資DAO，或者可以解釋為“投資非營利組織的風險投資公司”。

回溯性的資助者被稱為「概念性」政府。該專案直接受益的是誰？在RetroPGF的情況下，受益者是Optimism區塊鏈本身。這種資金來自L2序列器費用。（更多詳細解釋稍後提供）
...
創建一個DAO，並將所有Optimism收入轉交給該DAO。收入來自於在Optimism上進行的“Sequencing”（手續費）工作所獲得的利潤。

DAO決定將公共資金分配給哪些公共財（開源專案）。DAO根據專案是否已經做出貢獻來評估結果，而不是根據它在未來是否有用。這就是為什麼DAO的名字被描述為「成果預言機」（Result Oracles）。DAO最初將由約20至50位技術精湛的人組成。「在已經做出高貢獻的專案中做出選擇」的重點很重要，因為在DAO內更容易達成共識，選擇那些已經做出高貢獻的專案比起未來可能有用的專案更為明顯。

一旦決定了資金投放的地點，有多種方式可以為專案提供資金，包括
...
銷售一定數量的許可證。我們建議使用荷蘭拍賣（即降價拍賣）或頻道拍賣。在頻道拍賣中，有一個下限價格，這個價格逐漸增加以及逐漸下降的上限價格。買家承諾至少以最低價格購買但可以隨時以上限價格直接購買。

銷售一定數量的許可證。我們建議使用荷蘭拍賣（即降價拍賣）或頻道拍賣。在頻道拍賣中，有一個下限價格，這個價格逐漸增加以及逐漸下降的上限價格。買家承諾至少以最低價格購買但可以隨時以上限價格直接購買。

持有人在網上發布自我評估的估值，在這些平台上進行交易並支付年費（例如，20%的費用）。正確的年費率將會在某個範圍在零和周轉率之間（即在一年之内出现了更高价值的购买者。）
...
數位藝術產權系統是否改變了收藏家/贊助人與藝術家之間的關係？

提供更便捷的赞助管道是否能为艺术家创造更多收入？

這個財產權制度是否能夠為創意作品提供更可持續的資金支持？

一個始終開放的藝術品拍賣和市場，以及隨之而來的投機和定價，是否改變了人們對藝術和藝術家的關係？

數位藝術的交易量增加以及更多人擁有的可能性是否增加了藝術品的價值（無論是在財務上還是藝術上）？

總是處於特價狀態的藝術品，是否能幫助我們了解我們目前生活中有多少東西已經在不知不覺中一直處於特價狀態？
